...
module Dnsruby
  ...
  class Name
    include Comparable
    MaxNameLength = ENV['DNSRUBY_MAX_NAME_LENGTH'].nil? ? 255 : ENV['DNSRUBY_MAX_NAME_LENGTH'].to_i
    #--
    ...
    class Label
      include Comparable
      MaxLabelLength = ENV['DNSRUBY_MAX_LABEL_LENGTH'].nil? ? 63 : ENV['DNSRUBY_MAX_LABEL_LENGTH'].to_i
